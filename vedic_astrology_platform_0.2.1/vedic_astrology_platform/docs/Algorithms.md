...
## Metadata versus calculation rules

Varga metadata is registered in `core/varga_registry.py`. Numerical longitude transformations remain isolated in `core/varga.py`. Keeping these concerns separate allows labels and documentation to change without altering calculations.
